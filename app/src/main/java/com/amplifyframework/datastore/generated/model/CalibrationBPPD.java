...
/** This is an auto generated class representing the CalibrationBPPD type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "CalibrationBPPDS", type = Model.Type.USER, version = 1, authRules = {
  @AuthRule(allow = AuthStrategy.OWNER, ownerField = "owner", identityClaim = "cognito:username", provider = "userPools", operations = { ModelOperation.CREATE, ModelOperation.UPDATE, ModelOperation.DELETE, ModelOperation.READ })
}, hasLazySupport = true)
public final class CalibrationBPPD implements Model {
  public static final CalibrationBPPDPath rootPath = new CalibrationBPPDPath("root", false, null);
  public static final QueryField ID = field("CalibrationBPPD", "id");
  public static final QueryField NUMBER = field("CalibrationBPPD", "number");
  public static final QueryField HWFW = field("CalibrationBPPD", "hwfw");
  public static final QueryField GOLDEN = field("CalibrationBPPD", "golden");
  public static final QueryField DATATIME = field("CalibrationBPPD", "datatime");
  public static final QueryField DATAVALUE = field("CalibrationBPPD", "datavalue");
  public static final QueryField TEMPERATURE = field("CalibrationBPPD", "temperature");
  public static final QueryField GSENSOR = field("CalibrationBPPD", "gsensor");
  ...
  private CalibrationBPPD(String id, String number, String hwfw, Integer golden, List<Integer> datatime, List<Integer> datavalue, String temperature, List<Integer> gsensor) {
    this.id = id;
    this.number = number;
    this.hwfw = hwfw;
    this.golden = golden;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      CalibrationBPPD calibrationBppd = (CalibrationBPPD) obj;
      return ObjectsCompat.equals(getId(), calibrationBppd.getId()) &&
              ObjectsCompat.equals(getNumber(), calibrationBppd.getNumber()) &&
              ObjectsCompat.equals(getHwfw(), calibrationBppd.getHwfw()) &&
              ObjectsCompat.equals(getGolden(), calibrationBppd.getGolden()) &&
              ObjectsCompat.equals(getDatatime(), calibrationBppd.getDatatime()) &&
              ObjectsCompat.equals(getDatavalue(), calibrationBppd.getDatavalue()) &&
              ObjectsCompat.equals(getTemperature(), calibrationBppd.getTemperature()) &&
              ObjectsCompat.equals(getGsensor(), calibrationBppd.getGsensor()) &&
              ObjectsCompat.equals(getCreatedAt(), calibrationBppd.getCreatedAt()) &&
              ObjectsCompat.equals(getUpdatedAt(), calibrationBppd.getUpdatedAt());
      }
  }
   ...
   */
  public static CalibrationBPPD justId(String id) {
    return new CalibrationBPPD(
      id,
      null,
      null,
      null,
  ...
  public static class CalibrationBPPDIdentifier extends ModelIdentifier<CalibrationBPPD> {
    private static final long serialVersionUID = 1L;
    public CalibrationBPPDIdentifier(String id) {
      super(id);
    }
  }
