...
/** This is an auto generated class representing the TestHR type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "TestHRS", type = Model.Type.USER, version = 1, authRules = {
  @AuthRule(allow = AuthStrategy.OWNER, ownerField = "owner", identityClaim = "cognito:username", provider = "userPools", operations = { ModelOperation.CREATE, ModelOperation.UPDATE, ModelOperation.DELETE, ModelOperation.READ })
}, hasLazySupport = true)
public final class TestHR implements Model {
  public static final TestHRPath rootPath = new TestHRPath("root", false, null);
  public static final QueryField ID = field("TestHR", "id");
  public static final QueryField NUMBER = field("TestHR", "number");
  public static final QueryField HWFW = field("TestHR", "hwfw");
  public static final QueryField GOLDEN = field("TestHR", "golden");
  public static final QueryField DATATIME = field("TestHR", "datatime");
  public static final QueryField DATAVALUE = field("TestHR", "datavalue");
  public static final QueryField TEMPERATURE = field("TestHR", "temperature");
  public static final QueryField GSENSOR = field("TestHR", "gsensor");
  ...
  private TestHR(String id, String number, String hwfw, Integer golden, List<Integer> datatime, List<Integer> datavalue, String temperature, List<Integer> gsensor) {
    this.id = id;
    this.number = number;
    this.hwfw = hwfw;
    this.golden = golden;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      TestHR testHr = (TestHR) obj;
      return ObjectsCompat.equals(getId(), testHr.getId()) &&
              ObjectsCompat.equals(getNumber(), testHr.getNumber()) &&
              ObjectsCompat.equals(getHwfw(), testHr.getHwfw()) &&
              ObjectsCompat.equals(getGolden(), testHr.getGolden()) &&
              ObjectsCompat.equals(getDatatime(), testHr.getDatatime()) &&
              ObjectsCompat.equals(getDatavalue(), testHr.getDatavalue()) &&
              ObjectsCompat.equals(getTemperature(), testHr.getTemperature()) &&
              ObjectsCompat.equals(getGsensor(), testHr.getGsensor()) &&
              ObjectsCompat.equals(getCreatedAt(), testHr.getCreatedAt()) &&
              ObjectsCompat.equals(getUpdatedAt(), testHr.getUpdatedAt());
      }
  }
   ...
   */
  public static TestHR justId(String id) {
    return new TestHR(
      id,
      null,
      null,
  ...
  public static class TestHRIdentifier extends ModelIdentifier<TestHR> {
    private static final long serialVersionUID = 1L;
    public TestHRIdentifier(String id) {
      super(id);
    }
  }
