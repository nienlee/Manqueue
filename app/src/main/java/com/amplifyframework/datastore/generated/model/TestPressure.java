...
/** This is an auto generated class representing the TestPressure type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "TestPressures", type = Model.Type.USER, version = 1, authRules = {
  @AuthRule(allow = AuthStrategy.OWNER, ownerField = "owner", identityClaim = "cognito:username", provider = "userPools", operations = { ModelOperation.CREATE, ModelOperation.UPDATE, ModelOperation.DELETE, ModelOperation.READ })
}, hasLazySupport = true)
public final class TestPressure implements Model {
  public static final TestPressurePath rootPath = new TestPressurePath("root", false, null);
  public static final QueryField ID = field("TestPressure", "id");
  public static final QueryField NUMBER = field("TestPressure", "number");
  public static final QueryField HWFW = field("TestPressure", "hwfw");
  public static final QueryField GOLDEN = field("TestPressure", "golden");
  public static final QueryField DATATIME = field("TestPressure", "datatime");
  public static final QueryField DATAVALUE = field("TestPressure", "datavalue");
  public static final QueryField TEMPERATURE = field("TestPressure", "temperature");
  public static final QueryField GSENSOR = field("TestPressure", "gsensor");
  ...
  private TestPressure(String id, String number, String hwfw, Integer golden, List<Integer> datatime, List<Integer> datavalue, String temperature, List<Integer> gsensor) {
    this.id = id;
    this.number = number;
    this.hwfw = hwfw;
    this.golden = golden;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      TestPressure testPressure = (TestPressure) obj;
      return ObjectsCompat.equals(getId(), testPressure.getId()) &&
              ObjectsCompat.equals(getNumber(), testPressure.getNumber()) &&
              ObjectsCompat.equals(getHwfw(), testPressure.getHwfw()) &&
              ObjectsCompat.equals(getGolden(), testPressure.getGolden()) &&
              ObjectsCompat.equals(getDatatime(), testPressure.getDatatime()) &&
              ObjectsCompat.equals(getDatavalue(), testPressure.getDatavalue()) &&
              ObjectsCompat.equals(getTemperature(), testPressure.getTemperature()) &&
              ObjectsCompat.equals(getGsensor(), testPressure.getGsensor()) &&
              ObjectsCompat.equals(getCreatedAt(), testPressure.getCreatedAt()) &&
              ObjectsCompat.equals(getUpdatedAt(), testPressure.getUpdatedAt());
      }
  }
   ...
   */
  public static TestPressure justId(String id) {
    return new TestPressure(
      id,
      null,
      null,
      null,
  ...
  public static class TestPressureIdentifier extends ModelIdentifier<TestPressure> {
    private static final long serialVersionUID = 1L;
    public TestPressureIdentifier(String id) {
      super(id);
    }
  }
