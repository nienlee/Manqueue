...
/** This is an auto generated class representing the TestSleep type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "TestSleeps", type = Model.Type.USER, version = 1, authRules = {
  @AuthRule(allow = AuthStrategy.OWNER, ownerField = "owner", identityClaim = "cognito:username", provider = "userPools", operations = { ModelOperation.CREATE, ModelOperation.UPDATE, ModelOperation.DELETE, ModelOperation.READ })
}, hasLazySupport = true)
public final class TestSleep implements Model {
  public static final TestSleepPath rootPath = new TestSleepPath("root", false, null);
  public static final QueryField ID = field("TestSleep", "id");
  public static final QueryField NUMBER = field("TestSleep", "number");
  public static final QueryField HWFW = field("TestSleep", "hwfw");
  public static final QueryField GOLDEN = field("TestSleep", "golden");
  public static final QueryField DATATIME = field("TestSleep", "datatime");
  public static final QueryField DATAVALUE = field("TestSleep", "datavalue");
  public static final QueryField TEMPERATURE = field("TestSleep", "temperature");
  public static final QueryField GSENSOR = field("TestSleep", "gsensor");
  ...
  private TestSleep(String id, String number, String hwfw, Integer golden, List<Integer> datatime, List<Integer> datavalue, String temperature, List<Integer> gsensor) {
    this.id = id;
    this.number = number;
    this.hwfw = hwfw;
    this.golden = golden;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      TestSleep testSleep = (TestSleep) obj;
      return ObjectsCompat.equals(getId(), testSleep.getId()) &&
              ObjectsCompat.equals(getNumber(), testSleep.getNumber()) &&
              ObjectsCompat.equals(getHwfw(), testSleep.getHwfw()) &&
              ObjectsCompat.equals(getGolden(), testSleep.getGolden()) &&
              ObjectsCompat.equals(getDatatime(), testSleep.getDatatime()) &&
              ObjectsCompat.equals(getDatavalue(), testSleep.getDatavalue()) &&
              ObjectsCompat.equals(getTemperature(), testSleep.getTemperature()) &&
              ObjectsCompat.equals(getGsensor(), testSleep.getGsensor()) &&
              ObjectsCompat.equals(getCreatedAt(), testSleep.getCreatedAt()) &&
              ObjectsCompat.equals(getUpdatedAt(), testSleep.getUpdatedAt());
      }
  }
   ...
   */
  public static TestSleep justId(String id) {
    return new TestSleep(
      id,
      null,
      null,
      null,
  ...
  public static class TestSleepIdentifier extends ModelIdentifier<TestSleep> {
    private static final long serialVersionUID = 1L;
    public TestSleepIdentifier(String id) {
      super(id);
    }
  }
