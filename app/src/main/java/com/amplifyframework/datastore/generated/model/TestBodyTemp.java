...
/** This is an auto generated class representing the TestBodyTemp type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "TestBodyTemps", type = Model.Type.USER, version = 1, authRules = {
  @AuthRule(allow = AuthStrategy.OWNER, ownerField = "owner", identityClaim = "cognito:username", provider = "userPools", operations = { ModelOperation.CREATE, ModelOperation.UPDATE, ModelOperation.DELETE, ModelOperation.READ })
}, hasLazySupport = true)
public final class TestBodyTemp implements Model {
  public static final TestBodyTempPath rootPath = new TestBodyTempPath("root", false, null);
  public static final QueryField ID = field("TestBodyTemp", "id");
  public static final QueryField NUMBER = field("TestBodyTemp", "number");
  public static final QueryField HWFW = field("TestBodyTemp", "hwfw");
  public static final QueryField GOLDEN = field("TestBodyTemp", "golden");
  public static final QueryField DATATIME = field("TestBodyTemp", "datatime");
  public static final QueryField DATAVALUE = field("TestBodyTemp", "datavalue");
  public static final QueryField TEMPERATURE = field("TestBodyTemp", "temperature");
  public static final QueryField GSENSOR = field("TestBodyTemp", "gsensor");
  ...
  private TestBodyTemp(String id, String number, String hwfw, Integer golden, List<Integer> datatime, List<Integer> datavalue, String temperature, List<Integer> gsensor) {
    this.id = id;
    this.number = number;
    this.hwfw = hwfw;
    this.golden = golden;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      TestBodyTemp testBodyTemp = (TestBodyTemp) obj;
      return ObjectsCompat.equals(getId(), testBodyTemp.getId()) &&
              ObjectsCompat.equals(getNumber(), testBodyTemp.getNumber()) &&
              ObjectsCompat.equals(getHwfw(), testBodyTemp.getHwfw()) &&
              ObjectsCompat.equals(getGolden(), testBodyTemp.getGolden()) &&
              ObjectsCompat.equals(getDatatime(), testBodyTemp.getDatatime()) &&
              ObjectsCompat.equals(getDatavalue(), testBodyTemp.getDatavalue()) &&
              ObjectsCompat.equals(getTemperature(), testBodyTemp.getTemperature()) &&
              ObjectsCompat.equals(getGsensor(), testBodyTemp.getGsensor()) &&
              ObjectsCompat.equals(getCreatedAt(), testBodyTemp.getCreatedAt()) &&
              ObjectsCompat.equals(getUpdatedAt(), testBodyTemp.getUpdatedAt());
      }
  }
   ...
   */
  public static TestBodyTemp justId(String id) {
    return new TestBodyTemp(
      id,
      null,
      null,
      null,
  ...
  public static class TestBodyTempIdentifier extends ModelIdentifier<TestBodyTemp> {
    private static final long serialVersionUID = 1L;
    public TestBodyTempIdentifier(String id) {
      super(id);
    }
  }
