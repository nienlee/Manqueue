...
/** This is an auto generated class representing the TestHRV type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "TestHRVS", type = Model.Type.USER, version = 1, authRules = {
  @AuthRule(allow = AuthStrategy.OWNER, ownerField = "owner", identityClaim = "cognito:username", provider = "userPools", operations = { ModelOperation.CREATE, ModelOperation.UPDATE, ModelOperation.DELETE, ModelOperation.READ })
}, hasLazySupport = true)
public final class TestHRV implements Model {
  public static final TestHRVPath rootPath = new TestHRVPath("root", false, null);
  public static final QueryField ID = field("TestHRV", "id");
  public static final QueryField NUMBER = field("TestHRV", "number");
  public static final QueryField HWFW = field("TestHRV", "hwfw");
  public static final QueryField GOLDEN = field("TestHRV", "golden");
  public static final QueryField DATATIME = field("TestHRV", "datatime");
  public static final QueryField DATAVALUE = field("TestHRV", "datavalue");
  public static final QueryField TEMPERATURE = field("TestHRV", "temperature");
  public static final QueryField GSENSOR = field("TestHRV", "gsensor");
  ...
  private TestHRV(String id, String number, String hwfw, Integer golden, List<Integer> datatime, List<Integer> datavalue, String temperature, List<Integer> gsensor) {
    this.id = id;
    this.number = number;
    this.hwfw = hwfw;
    this.golden = golden;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      TestHRV testHrv = (TestHRV) obj;
      return ObjectsCompat.equals(getId(), testHrv.getId()) &&
              ObjectsCompat.equals(getNumber(), testHrv.getNumber()) &&
              ObjectsCompat.equals(getHwfw(), testHrv.getHwfw()) &&
              ObjectsCompat.equals(getGolden(), testHrv.getGolden()) &&
              ObjectsCompat.equals(getDatatime(), testHrv.getDatatime()) &&
              ObjectsCompat.equals(getDatavalue(), testHrv.getDatavalue()) &&
              ObjectsCompat.equals(getTemperature(), testHrv.getTemperature()) &&
              ObjectsCompat.equals(getGsensor(), testHrv.getGsensor()) &&
              ObjectsCompat.equals(getCreatedAt(), testHrv.getCreatedAt()) &&
              ObjectsCompat.equals(getUpdatedAt(), testHrv.getUpdatedAt());
      }
  }
   ...
   */
  public static TestHRV justId(String id) {
    return new TestHRV(
      id,
      null,
      null,
  ...
  public static class TestHRVIdentifier extends ModelIdentifier<TestHRV> {
    private static final long serialVersionUID = 1L;
    public TestHRVIdentifier(String id) {
      super(id);
    }
  }
