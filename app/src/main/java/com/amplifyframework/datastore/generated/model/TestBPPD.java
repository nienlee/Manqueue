...
/** This is an auto generated class representing the TestBPPD type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "TestBPPDS", type = Model.Type.USER, version = 1, authRules = {
  @AuthRule(allow = AuthStrategy.OWNER, ownerField = "owner", identityClaim = "cognito:username", provider = "userPools", operations = { ModelOperation.CREATE, ModelOperation.UPDATE, ModelOperation.DELETE, ModelOperation.READ })
}, hasLazySupport = true)
public final class TestBPPD implements Model {
  public static final TestBPPDPath rootPath = new TestBPPDPath("root", false, null);
  public static final QueryField ID = field("TestBPPD", "id");
  public static final QueryField NUMBER = field("TestBPPD", "number");
  public static final QueryField HWFW = field("TestBPPD", "hwfw");
  public static final QueryField GOLDEN = field("TestBPPD", "golden");
  public static final QueryField DATATIME = field("TestBPPD", "datatime");
  public static final QueryField DATAVALUE = field("TestBPPD", "datavalue");
  public static final QueryField TEMPERATURE = field("TestBPPD", "temperature");
  public static final QueryField GSENSOR = field("TestBPPD", "gsensor");
  ...
  private TestBPPD(String id, String number, String hwfw, Integer golden, List<Integer> datatime, List<Integer> datavalue, String temperature, List<Integer> gsensor) {
    this.id = id;
    this.number = number;
    this.hwfw = hwfw;
    this.golden = golden;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      TestBPPD testBppd = (TestBPPD) obj;
      return ObjectsCompat.equals(getId(), testBppd.getId()) &&
              ObjectsCompat.equals(getNumber(), testBppd.getNumber()) &&
              ObjectsCompat.equals(getHwfw(), testBppd.getHwfw()) &&
              ObjectsCompat.equals(getGolden(), testBppd.getGolden()) &&
              ObjectsCompat.equals(getDatatime(), testBppd.getDatatime()) &&
              ObjectsCompat.equals(getDatavalue(), testBppd.getDatavalue()) &&
              ObjectsCompat.equals(getTemperature(), testBppd.getTemperature()) &&
              ObjectsCompat.equals(getGsensor(), testBppd.getGsensor()) &&
              ObjectsCompat.equals(getCreatedAt(), testBppd.getCreatedAt()) &&
              ObjectsCompat.equals(getUpdatedAt(), testBppd.getUpdatedAt());
      }
  }
   ...
   */
  public static TestBPPD justId(String id) {
    return new TestBPPD(
      id,
      null,
      null,
  ...
  public static class TestBPPDIdentifier extends ModelIdentifier<TestBPPD> {
    private static final long serialVersionUID = 1L;
    public TestBPPDIdentifier(String id) {
      super(id);
    }
  }
