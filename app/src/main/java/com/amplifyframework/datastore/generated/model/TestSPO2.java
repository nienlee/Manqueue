...
/** This is an auto generated class representing the TestSPO2 type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "TestSPO2s", type = Model.Type.USER, version = 1, authRules = {
  @AuthRule(allow = AuthStrategy.OWNER, ownerField = "owner", identityClaim = "cognito:username", provider = "userPools", operations = { ModelOperation.CREATE, ModelOperation.UPDATE, ModelOperation.DELETE, ModelOperation.READ })
}, hasLazySupport = true)
public final class TestSPO2 implements Model {
  public static final TestSPO2Path rootPath = new TestSPO2Path("root", false, null);
  public static final QueryField ID = field("TestSPO2", "id");
  public static final QueryField NUMBER = field("TestSPO2", "number");
  public static final QueryField HWFW = field("TestSPO2", "hwfw");
  public static final QueryField GOLDEN = field("TestSPO2", "golden");
  public static final QueryField DATATIME = field("TestSPO2", "datatime");
  public static final QueryField DATAVALUE = field("TestSPO2", "datavalue");
  public static final QueryField TEMPERATURE = field("TestSPO2", "temperature");
  public static final QueryField GSENSOR = field("TestSPO2", "gsensor");
  ...
  private TestSPO2(String id, String number, String hwfw, Integer golden, List<Integer> datatime, List<Integer> datavalue, String temperature, List<Integer> gsensor) {
    this.id = id;
    this.number = number;
    this.hwfw = hwfw;
    this.golden = golden;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      TestSPO2 testSpo2 = (TestSPO2) obj;
      return ObjectsCompat.equals(getId(), testSpo2.getId()) &&
              ObjectsCompat.equals(getNumber(), testSpo2.getNumber()) &&
              ObjectsCompat.equals(getHwfw(), testSpo2.getHwfw()) &&
              ObjectsCompat.equals(getGolden(), testSpo2.getGolden()) &&
              ObjectsCompat.equals(getDatatime(), testSpo2.getDatatime()) &&
              ObjectsCompat.equals(getDatavalue(), testSpo2.getDatavalue()) &&
              ObjectsCompat.equals(getTemperature(), testSpo2.getTemperature()) &&
              ObjectsCompat.equals(getGsensor(), testSpo2.getGsensor()) &&
              ObjectsCompat.equals(getCreatedAt(), testSpo2.getCreatedAt()) &&
              ObjectsCompat.equals(getUpdatedAt(), testSpo2.getUpdatedAt());
      }
  }
   ...
   */
  public static TestSPO2 justId(String id) {
    return new TestSPO2(
      id,
      null,
      null,
  ...
  public static class TestSPO2Identifier extends ModelIdentifier<TestSPO2> {
    private static final long serialVersionUID = 1L;
    public TestSPO2Identifier(String id) {
      super(id);
    }
  }
