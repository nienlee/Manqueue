...
/** This is an auto generated class representing the TestActivityStepCalorie type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "TestActivityStepCalories", type = Model.Type.USER, version = 1, authRules = {
  @AuthRule(allow = AuthStrategy.OWNER, ownerField = "owner", identityClaim = "cognito:username", provider = "userPools", operations = { ModelOperation.CREATE, ModelOperation.UPDATE, ModelOperation.DELETE, ModelOperation.READ })
}, hasLazySupport = true)
public final class TestActivityStepCalorie implements Model {
  public static final TestActivityStepCaloriePath rootPath = new TestActivityStepCaloriePath("root", false, null);
  public static final QueryField ID = field("TestActivityStepCalorie", "id");
  public static final QueryField NUMBER = field("TestActivityStepCalorie", "number");
  public static final QueryField HWFW = field("TestActivityStepCalorie", "hwfw");
  public static final QueryField GOLDEN = field("TestActivityStepCalorie", "golden");
  public static final QueryField DATATIME = field("TestActivityStepCalorie", "datatime");
  public static final QueryField DATAVALUE = field("TestActivityStepCalorie", "datavalue");
  public static final QueryField TEMPERATURE = field("TestActivityStepCalorie", "temperature");
  public static final QueryField GSENSOR = field("TestActivityStepCalorie", "gsensor");
  ...
  private TestActivityStepCalorie(String id, String number, String hwfw, Integer golden, List<Integer> datatime, List<Integer> datavalue, String temperature, List<Integer> gsensor) {
    this.id = id;
    this.number = number;
    this.hwfw = hwfw;
    this.golden = golden;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      TestActivityStepCalorie testActivityStepCalorie = (TestActivityStepCalorie) obj;
      return ObjectsCompat.equals(getId(), testActivityStepCalorie.getId()) &&
              ObjectsCompat.equals(getNumber(), testActivityStepCalorie.getNumber()) &&
              ObjectsCompat.equals(getHwfw(), testActivityStepCalorie.getHwfw()) &&
              ObjectsCompat.equals(getGolden(), testActivityStepCalorie.getGolden()) &&
              ObjectsCompat.equals(getDatatime(), testActivityStepCalorie.getDatatime()) &&
              ObjectsCompat.equals(getDatavalue(), testActivityStepCalorie.getDatavalue()) &&
              ObjectsCompat.equals(getTemperature(), testActivityStepCalorie.getTemperature()) &&
              ObjectsCompat.equals(getGsensor(), testActivityStepCalorie.getGsensor()) &&
              ObjectsCompat.equals(getCreatedAt(), testActivityStepCalorie.getCreatedAt()) &&
              ObjectsCompat.equals(getUpdatedAt(), testActivityStepCalorie.getUpdatedAt());
      }
  }
  ...
  @Override
   public String toString() {
    return new StringBuilder()
      .append("TestActivityStepCalorie {")
   ...
   */
  public static TestActivityStepCalorie justId(String id) {
    return new TestActivityStepCalorie(
      id,
      null,
      null,
      null,
  ...
  public static class Builder implements TemperatureStep, BuildStep {
    ...
    @Override
     public TestActivityStepCalorie build() {
  ...
  public static class TestActivityStepCalorieIdentifier extends ModelIdentifier<TestActivityStepCalorie> {
    private static final long serialVersionUID = 1L;
    public TestActivityStepCalorieIdentifier(String id) {
      super(id);
    }
  }
