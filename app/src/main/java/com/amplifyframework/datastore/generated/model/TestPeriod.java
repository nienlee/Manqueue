...
/** This is an auto generated class representing the TestPeriod type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "TestPeriods", type = Model.Type.USER, version = 1, authRules = {
  @AuthRule(allow = AuthStrategy.OWNER, ownerField = "owner", identityClaim = "cognito:username", provider = "userPools", operations = { ModelOperation.CREATE, ModelOperation.UPDATE, ModelOperation.DELETE, ModelOperation.READ })
}, hasLazySupport = true)
public final class TestPeriod implements Model {
  public static final TestPeriodPath rootPath = new TestPeriodPath("root", false, null);
  public static final QueryField ID = field("TestPeriod", "id");
  public static final QueryField NUMBER = field("TestPeriod", "number");
  public static final QueryField HWFW = field("TestPeriod", "hwfw");
  public static final QueryField GOLDEN = field("TestPeriod", "golden");
  public static final QueryField DATATIME = field("TestPeriod", "datatime");
  public static final QueryField DATAVALUE = field("TestPeriod", "datavalue");
  public static final QueryField TEMPERATURE = field("TestPeriod", "temperature");
  public static final QueryField GSENSOR = field("TestPeriod", "gsensor");
  ...
  private TestPeriod(String id, String number, String hwfw, Integer golden, List<Integer> datatime, List<Integer> datavalue, String temperature, List<Integer> gsensor) {
    this.id = id;
    this.number = number;
    this.hwfw = hwfw;
    this.golden = golden;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      TestPeriod testPeriod = (TestPeriod) obj;
      return ObjectsCompat.equals(getId(), testPeriod.getId()) &&
              ObjectsCompat.equals(getNumber(), testPeriod.getNumber()) &&
              ObjectsCompat.equals(getHwfw(), testPeriod.getHwfw()) &&
              ObjectsCompat.equals(getGolden(), testPeriod.getGolden()) &&
              ObjectsCompat.equals(getDatatime(), testPeriod.getDatatime()) &&
              ObjectsCompat.equals(getDatavalue(), testPeriod.getDatavalue()) &&
              ObjectsCompat.equals(getTemperature(), testPeriod.getTemperature()) &&
              ObjectsCompat.equals(getGsensor(), testPeriod.getGsensor()) &&
              ObjectsCompat.equals(getCreatedAt(), testPeriod.getCreatedAt()) &&
              ObjectsCompat.equals(getUpdatedAt(), testPeriod.getUpdatedAt());
      }
  }
   ...
   */
  public static TestPeriod justId(String id) {
  ...
  public static class TestPeriodIdentifier extends ModelIdentifier<TestPeriod> {
    private static final long serialVersionUID = 1L;
    public TestPeriodIdentifier(String id) {
      super(id);
    }
  }
